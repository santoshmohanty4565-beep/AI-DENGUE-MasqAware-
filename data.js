...
const ODISHA_DATA = {
  ...
  osdmaStateProfile: {
    ...
    areaPctNational: 4.87,
    coastlineKm: 480,
    geographicalRegions: ["Northern Plateau", "Central River Basins", "Eastern Hills", "Coastal Plains"],
    agroClimaticZones: 10,
    revenueDivisions: [
      { name: "Central Division", headquarters: "Cuttack", districtsCount: 10, districts: ["Cuttack", "Jagatsinghpur", "Kendrapada", "Jajpur", "Balasore", "Bhadrak", "Puri", "Khordha", "Nayagarh", "Mayurbhanj"] },
      { name: "Southern Division", headquarters: "Berhampur", districtsCount: 10, districts: ["Ganjam", "Gajapati", "Koraput", "Nabarangpur", "Rayagada", "Malkangiri", "Kalahandi", "Nuapada", "Kandhamal", "Boudh"] },
      { name: "Northern Division", headquarters: "Sambalpur", districtsCount: 10, districts: ["Sambalpur", "Deogarh", "Jharsuguda", "Bargarh", "Bolangir", "Sonepur", "Sundargarh", "Dhenkanal", "Angul", "Keonjhar"] }
    ],
    districtsCount: 30,
